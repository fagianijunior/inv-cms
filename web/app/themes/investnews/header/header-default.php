<header id="header-investnews">
    ...
    <div class="side-menu-area">
        ...
        <div class="trending">
            <div class="container">
                <?php 
                    $trending_menu = get_term_by('name', 'Links em Alta', 'nav_menu');
                    $trending_menu_id = $trending_menu->term_id;
                    $trending_menu_title = get_field('trending_menu_title', 'nav_menu_' . $trending_menu_id);
                    if(!$trending_menu_title) {
                        $trending_menu_title = 'TRENDING';
                    }
                    if ( has_nav_menu( 'trending-menu-header' ) ) {
                        wp_nav_menu(array( 
                            'menu_class'     => 'trending-menu-header',
                            'items_wrap'     => '<ul id="%1$s" class="%2$s"><li id="menu-item-title" class="menu-item menu-item-type-custom menu-item-object-custom">'.$trending_menu_title.'</li>%3$s</ul>',
                            'theme_location' => 'trending-menu-header' ) 
                        ); 
                    }
                ?>
            </div>
