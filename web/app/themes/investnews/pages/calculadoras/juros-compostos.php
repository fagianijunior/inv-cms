<?php
/*
* Template Name: Calculadora de juros compostos 
* @package WordPress
                    ...
                    <div class="group-itens">
                        <div class="input input-w-buttons">
                            ...
                            <div class="input-content">
                                <input type="text" name="inputCapitalInicial" id="inputCapitalInicial" placeholder="R$ 0,00" value="R$ 0,00">
                        ...
                        <div class="input input-w-buttons">
                            <label for="inputCapitalMensal">
                                ...
                                <div class="tooltip top">
                                    ...
                                    <div class="tooltiptext">
                                        Quantidade investida mensalmente durante o periodo.
                                    </div>
                                </div>
                            </label>
                            <div class="input-content">
                                <input type="text" name="inputCapitalMensal" id="inputCapitalMensal" placeholder="R$ 0,00" value="R$ 0,00">
                                <div class="button-group">
                                    <button type="button" class="input-button remove" onclick="changeMaskedMoneyValue('inputCapitalMensal',-100)">-</button>
                                    <button type="button" class="input-button add" onclick="changeMaskedMoneyValue('inputCapitalMensal', 100)">+</button>
                                </div>
                            </div>
                        </div>
                    </div>
