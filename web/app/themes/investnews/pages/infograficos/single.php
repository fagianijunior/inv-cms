...
<section class="singular-post default-post-template">
    <div class="top">
        <div class="container">             
            <a href="" class="tag">Infográficos</a>
            ...
            <div class="share">
                ...
                <div class="share-options">
                    <div class="option-list">
                        <!-- Copiar link -->
                        <a href="<?php echo get_the_permalink() ?>" id="copy-link-button" class="option-item">
                        ...
                        <!-- E-mail -->
                        <a href="mailto:?subject=<?php the_title(); ?>;body=<?php echo get_the_permalink() ?>" class="option-item">
                            <div class="option-icon">
    ...
    <?php if ( get_field('imagem_do_infografico') ) { ?>
        <div class="container large-info">
            <img src="<?php the_field('imagem_do_infografico') ?>" alt="">
        </div>
    <?php } else{ ?>
        <?php if ( has_post_thumbnail() ) { ?>
            ...
            <?php if($show_featured_image === true || $show_featured_image === NULL ) { ?>
                <div class="featured-image">
                    <div class="container">
                        <?php echo get_the_post_thumbnail($post_id, array( 1256, 692)); ?>
                    </div>
                </div>
            <?php } ?>
        <?php } ?> 
            ...
            <div class="tag-list">
                <?php foreach( $post_tags as $tag ) { ?>
                    <?php
                        ...
                        $tag_name = $tag->name;
                    ?>
                    <a href="<?php echo $tag_link ?>" class="tag-item">
                        <?php echo $tag_name ?>
                    </a>
                <?php } ?>
            </div>
    ...
    <?php if (function_exists('coauthors_posts_links')) { ?>
        <div class="post-author-list">
            ...
            ?>
                <div class="author">
                    <div class="top">
                        <a href="<?php echo $author_url; ?>" class="author-image">
                            <?php $profile_image = get_field('profile_image', 'user_'.$author_id); ?>
                            <?php if($profile_image) { ?>
                                <?php echo wp_get_attachment_image( $profile_image['ID'], array(40,40) ); ?>
                            <?php } else { ?>
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="41" viewBox="0 0 40 41" fill="none">
                                    <rect y="0.500977" width="40" height="40" rx="20" fill="#C4C4C4"/>
                                </svg>
                            <?php } ?>
                        </a>
                        <a href="<?php echo $author_url; ?>" class="author-name">
