...
<?php if($editorial_sponsored_by_status) {
    ?>
        <?php get_header(); ?>
        <?php
            global $post;
        ...
        <section class="singular-post sponsored-by-post-template">
            ...
            <?php echo get_template_part('components/on-code/post-parts/top-area-editorial-sponsored-by/top-area-editorial-sponsored-by')?>
